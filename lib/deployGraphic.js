...
module.exports = async function(config, slug, fileFilter = null) {
  ...
  // if a file filter was provided, use that. Else fall back to the manifest, and finally use the defaults.
  var patterns = fileFilter || manifest.files || [
    "index.html",
    "graphic.js",
    "graphic.less",
    "*.png",
  ...
  patterns.push("!**/synced/**/*", "!manifest.json");
  // de-dupe the patterns
